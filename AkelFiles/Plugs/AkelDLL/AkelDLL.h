...
#define IDM_EDIT_FINDNEXTDOWN           4159  //Find last string down.
                                              //Return Value: Character position of the next match. If there are no more matches, the return value is ?.
                                              //
...
Return Value
 ...
 If there are no more matches, the return value is ?.
 If there is syntax error occurred with FRF_REGEXP or FRF_ESCAPESEQ flag, the return value is (?00 - PatternOffset).
 For example, TEXTFINDW.pFindIt equal to "ab[c" with FRF_REGEXP, syntax error in third symbol, return value is ?02.
...
Return Value
 ...
 If there are no more matches, the return value is ?.
 If there is syntax error occurred with FRF_REGEXP or FRF_ESCAPESEQ flag, the return value is (?00 - PatternOffset).
 For example, TEXTREPLACEW.pFindIt equal to "ab[c" with FRF_REGEXP, syntax error in third symbol, return value is ?02.
